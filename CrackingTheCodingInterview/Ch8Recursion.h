 ...
 * a point, and a new color, fill in the surrounding area until you hit a
 * border of that color
 */
// Application Interface, decipher the value of the current location
void prob8_6(int** grid, int N, int r, int c, int fill);
// Performs the fill
void prob8_6(int** grid, int N, int r, int c, int cur, int fill);
}
